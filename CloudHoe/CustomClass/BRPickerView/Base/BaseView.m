...
//        _leftBtn.layer.masksToBounds = YES;
        ...
        [_leftBtn setTitleColor:RGB_HEX(0x50DBD1, 1.0) forState:UIControlStateNormal];
...
//        _rightBtn.layer.masksToBounds = YES;
        ...
        [_rightBtn setTitleColor:RGB_HEX(0x50DBD1, 1.0) forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = RGB_HEX(0x313131, 1.0);
