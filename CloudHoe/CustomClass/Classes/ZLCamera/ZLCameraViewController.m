...
- (void) setup{
    ...
    UIButton *cancelBtn = [UIButton buttonWithframe:CGRectMake(0, 0, 55, 55) text:@"" font:[UIFont systemFontOfSize:16] textColor:@"#FFFFFF" backgroundColor:@"" normal:@"Fill 4" selected:nil];
    [self.view addSubview:cancelBtn];
    [cancelBtn addTarget:self action:@selector(cancelAction) forControlEvents:UIControlEventTouchUpInside];
    
    UIButton *cameraBtn = [UIButton buttonWithframe:CGRectMake((kScreenWidth-80)/2, kScreenHeight-32-80, 80, 80) text:@"" font:[UIFont systemFontOfSize:16] textColor:@"#FFFFFF" backgroundColor:@"" normal:@"paizhao" selected:nil];
...
//         NSData *data = UIImagePNGRepresentation(t_image);
