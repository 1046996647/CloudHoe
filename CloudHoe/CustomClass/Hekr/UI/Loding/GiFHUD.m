...
+ (void)showWithOverlay:(UIView *)view{
    

    if ([[self instance] backgroundView].superview == view) {
        return;
    }
    
    [view addSubview:[[self instance] backgroundView]];
    
    [self show:view];

//    [self dismiss:^{
//        [view addSubview:[[self instance] overlay]];
//        
//        [self show:view];
//    }];
}
...
+ (void)show:(UIView *)view{
    ...
    UIView *view1 = [self instance];
    if (view1.superview == view) {
        return;
    }
...
//    [self dismiss:^{
////        UIView *view1 = [self instance];
////        view1.transform = CGAffineTransformMakeTranslation(0, -64);
//        [view addSubview:[self instance]];
//        [[self instance] setShown:YES];
//        [[self instance] fadeIn];
//    }];
...
//        [[self instance] overlay].alpha = 0;
//    } completion:^(BOOL finished) {
//        [[[self instance] overlay] removeFromSuperview];
//        [[self instance] removeFromSuperview];
//    }];
    [[self instance] fadeOut];
    [[[self instance] backgroundView] removeFromSuperview];
    [[self instance] removeFromSuperview];
    [APPDELEGATE.window addSubview:[self instance]];
...
- (UIView *)backgroundView{
    ...
    if (!self.bgView) {
        self.bgView = [[UIView alloc] initWithFrame:APPDELEGATE.window.frame];
